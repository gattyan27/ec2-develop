...
# register route53
curl https://raw.githubusercontent.com/gattyan27/ec2-develop/master/dyndns.tmpl -O
...
# ssh config
curl https://raw.githubusercontent.com/gattyan27/ec2-develop/master/sshd_config.tmpl -O
...
apt install -y nginx
curl https://raw.githubusercontent.com/gattyan27/ec2-develop/master/http.conf.tmpl -O
